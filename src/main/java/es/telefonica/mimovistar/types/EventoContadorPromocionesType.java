...
/**
 * <p>Java class for eventoContadorPromocionesType complex type.
 * 
...
@XmlType(name = "eventoContadorPromocionesType", propOrder = {
    "msisdn",
    "indicador",
    "fechaEvento",
    "puertoServidor",
...
public class EventoContadorPromocionesType {
